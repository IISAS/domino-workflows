...
dag_config_0 = {'start_date': '2026-02-27T10:38:00', 'schedule': None, 'catchup': False, 'dag_id': 'a4469bd5e7a444799ce4be1f867c75cb'}
...
with DAG(**dag_config) as dag:
    ...
    InferenceM_8fd11a7c16064e009c06ba747943f8a5 = Task(
        ...
        piece_input_kwargs={'test_data_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'output_arg': 'test_data_path'}, 'trained_model_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainRando_132faa29e7734205b37d2739542a6ac2', 'output_arg': 'random_forest_model_path'}, 'target_column': 'FVE'}
    )()
    ...
    InferenceM_b346a5037de24de3a5f451023ad524fd = Task(
        ...
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'InferenceModelPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
        piece_input_kwargs={'test_data_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'output_arg': 'test_data_path'}, 'trained_model_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainRando_5e74250717ab451498b93f0db257b286', 'output_arg': 'random_forest_model_path'}, 'target_column': 'FVE'}
    )()
    InferenceM_76297b55a58d462f81bc7f092eb357f2 = Task(
        ...
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'InferenceModelPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
        piece_input_kwargs={'test_data_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'output_arg': 'test_data_path'}, 'trained_model_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainRando_5c4008aca9d2410bbb5a8a733d3a1779', 'output_arg': 'random_forest_model_path'}, 'target_column': 'FVE'}
    )()
    InferenceM_29db434976b0411ab9f2b9a8f0410779 = Task(
        ...
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'InferenceModelPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
        piece_input_kwargs={'test_data_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'output_arg': 'test_data_path'}, 'trained_model_path': {'type': 'fromUpstream', 'upstream_task_id': 'TrainRando_96544c0d33c54b8bb44a97cdd6d66a40', 'output_arg': 'random_forest_model_path'}, 'target_column': 'FVE'}
    )()
    ...
    TrainRando_96544c0d33c54b8bb44a97cdd6d66a40 = Task(
        dag,
        task_id='TrainRando_96544c0d33c54b8bb44a97cdd6d66a40',
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
    ...
    TrainRando_5c4008aca9d2410bbb5a8a733d3a1779 = Task(
        dag,
        task_id='TrainRando_5c4008aca9d2410bbb5a8a733d3a1779',
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'TrainRandomForestRegressorPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
    ...
    TrainRando_5e74250717ab451498b93f0db257b286 = Task(
        dag,
        task_id='TrainRando_5e74250717ab451498b93f0db257b286',
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'TrainRandomForestRegressorPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
    ...
    TrainRando_132faa29e7734205b37d2739542a6ac2 = Task(
        dag,
        task_id='TrainRando_132faa29e7734205b37d2739542a6ac2',
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '1024.0Mi'}, 'use_gpu': False},
        piece={'name': 'TrainRandomForestRegressorPiece', 'source_image': 'ghcr.io/iisas/spice_domino_pieces:0.2.0-group0', 'repository_url': 'https://github.com/IISAS/spice_domino_pieces', 'repository_version': '0.2.0'},
    ...
    InferenceM_8fd11a7c16064e009c06ba747943f8a5.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'TrainRando_132faa29e7734205b37d2739542a6ac2']])
    ...
    InferenceM_b346a5037de24de3a5f451023ad524fd.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'TrainRando_5e74250717ab451498b93f0db257b286']])
    InferenceM_76297b55a58d462f81bc7f092eb357f2.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'TrainRando_5c4008aca9d2410bbb5a8a733d3a1779']])
    InferenceM_29db434976b0411ab9f2b9a8f0410779.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594', 'TrainRando_96544c0d33c54b8bb44a97cdd6d66a40']])
    TrainRando_96544c0d33c54b8bb44a97cdd6d66a40.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594']])
    TrainRando_5c4008aca9d2410bbb5a8a733d3a1779.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594']])
    TrainRando_5e74250717ab451498b93f0db257b286.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594']])
    TrainRando_132faa29e7734205b37d2739542a6ac2.set_upstream([globals()[t] for t in ['TrainTestS_fdb7e68571cf452dbbca9db0060fb594']])
