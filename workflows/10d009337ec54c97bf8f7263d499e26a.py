...
dag_config_0 = {'start_date': '2026-02-16T18:55:00', 'schedule': None, 'catchup': False, 'dag_id': '10d009337ec54c97bf8f7263d499e26a'}
...
with DAG(**dag_config) as dag:
    ...
    HttpReques_f27e3dfd8d014fa892ef6dc5707a0b22 = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?auto=compress&cs=tinysrgb&w=1260&h=7', 'method': 'GET', 'bearer_token': 'ZZZZ', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n'}
    )()
