...
dag_config_0 = {'start_date': '2026-03-04T13:11:00', 'schedule': None, 'catchup': False, 'dag_id': 'c50c20e6d97d4a1eb0e6eb861a5b00d7'}
...
with DAG(**dag_config) as dag:
    ...
    EvaluatePe_1b169d0f10cb4622b643b22afe826a1c = Task(
        ...
        piece_input_kwargs={'outputs_zip_path': {'type': 'fromUpstream', 'upstream_task_id': 'ExecuteFar_00e2456bfd7e4d8483be9720f0dc6b62', 'output_arg': 'outputs_zip_path'}, 'ignition_shp_path': {'type': 'fromUpstream', 'upstream_task_id': 'CreateIgni_7dfed19bc70d444299c71fb97c2f2855', 'output_arg': 'ignition_shp_path'}, 'buffer_shp_path': '/home/shared_storage/fire/buffer.shp', 'api_model_name': 'Model 1'}
    )()
