...
dag_config_0 = {'start_date': '2026-02-17T12:36:00', 'schedule': None, 'catchup': False, 'dag_id': '5d0cb49ce6aa40af8e1e5b0a55261f4d'}
...
with DAG(**dag_config) as dag:
    ...
    ImageFilte_8c046b5524464c19bc2b376dc3d0f649 = Task(
        ...
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '4096.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '4096.0Mi'}, 'use_gpu': False},
