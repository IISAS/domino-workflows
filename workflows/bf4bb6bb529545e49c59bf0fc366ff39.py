...
dag_config_0 = {'start_date': '2026-02-05T16:46:00', 'schedule': None, 'catchup': False, 'dag_id': 'bf4bb6bb529545e49c59bf0fc366ff39'}
...
with DAG(**dag_config) as dag:
    HttpReques_27dd10b0cd4b41a5bb118468b0a3c60b = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'method': 'GET', 'bearer_token': 'TTT', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n'}
    )()
    ImageFilte_7a0d7be2528e4149831ad0a4308dcb62 = Task(
        ...
        piece_input_kwargs={'input_image': {'type': 'fromUpstream', 'upstream_task_id': 'httpreques-27dd10b0cd4b41a5bb118468b0a3c60b', 'output_arg': 'base64_bytes_data'}, 'sepia': False, 'black_and_white': True, 'brightness': False, 'darkness': False, 'contrast': False, 'red': False, 'green': False, 'blue': False, 'cool': True, 'warm': False, 'output_type': 'both'}
    )()
