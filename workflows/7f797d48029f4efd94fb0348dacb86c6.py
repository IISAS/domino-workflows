...
dag_config_0 = {'start_date': '2026-02-17T09:39:00', 'schedule': None, 'catchup': False, 'dag_id': '7f797d48029f4efd94fb0348dacb86c6'}
...
with DAG(**dag_config) as dag:
    HttpReques_9b65825b0c114506be8d4e91c4042165 = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg', 'method': 'GET', 'bearer_token': 'ZZZZZ', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n', 'output_type': 'both'}
    )()
    ImageFilte_8c046b5524464c19bc2b376dc3d0f649 = Task(
        ...
        piece_input_kwargs={'input_image': {'type': 'fromUpstream', 'upstream_task_id': 'HttpReques_9b65825b0c114506be8d4e91c4042165', 'output_arg': 'image_file_path'}, 'sepia': True, 'black_and_white': False, 'brightness': False, 'darkness': True, 'contrast': False, 'red': False, 'green': False, 'blue': False, 'cool': False, 'warm': False, 'output_type': 'both'}
    )()
