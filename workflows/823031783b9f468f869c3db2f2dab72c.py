...
dag_config_0 = {'start_date': '2026-01-29T16:11:00', 'schedule': None, 'catchup': False, 'dag_id': '823031783b9f468f869c3db2f2dab72c'}
...
with DAG(**dag_config) as dag:
    HttpReques_27dd10b0cd4b41a5bb118468b0a3c60b = Task(
        ...
        workspace_id=1,
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {'bucket': 'ZZZZ', 'base_folder': 'YYYY'}},
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'method': 'GET', 'bearer_token': 'DDDD', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n'}
    )()
