...
dag_config_0 = {'start_date': '2026-03-02T16:21:00', 'schedule': None, 'catchup': False, 'dag_id': '28ebd3fe550a4e6b92b8f223f62a2443'}
...
with DAG(**dag_config) as dag:
    ExecuteFar_f9f2b90cd4b14e7688f9f59489752557 = Task(
        ...
        piece_input_kwargs={'lcp_path': '/mnt/data/data/fire/final.lcp', 'inputs_path': '/mnt/data/data/fire/Zavada.input', 'ignition_shp_path': '/mnt/data/data/fire/ignition.shp', 'barrier_shp_path': '0', 'output_basename': '/mnt/data/data/fire/output', 'outputs_type': 1}
    )()
