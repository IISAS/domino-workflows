...
dag_config_0 = {'start_date': '2026-01-22T08:11:00', 'schedule': None, 'catchup': False, 'dag_id': '540d2983e01e43949d7d499f72d8a157'}
...
with DAG(**dag_config) as dag:
    httpreques-27dd10b0cd4b41a5bb118468b0a3c60b = Task(
        dag,
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'method': 'GET', 'bearer_token': None, 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n'}
    )()
    imagefilte-7a0d7be2528e4149831ad0a4308dcb62 = Task(
        dag,
    ...
    imagefilte-7a0d7be2528e4149831ad0a4308dcb62.set_upstream([globals()[t] for t in ['httpreques-27dd10b0cd4b41a5bb118468b0a3c60b']])
