...
dag_config_0 = {'start_date': '2026-02-17T11:40:00', 'schedule': None, 'catchup': False, 'dag_id': 'e82e427d38114c18b2bcf498c6b7da0f'}
...
with DAG(**dag_config) as dag:
    HttpReques_9b65825b0c114506be8d4e91c4042165 = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?w=3000&h=1024', 'method': 'GET', 'bearer_token': 'ZZZZZ', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n', 'output_type': 'both'}
    )()
