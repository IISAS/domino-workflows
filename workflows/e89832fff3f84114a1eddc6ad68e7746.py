...
dag_config_0 = {'start_date': '2026-02-26T13:47:00', 'schedule': None, 'catchup': False, 'dag_id': 'e89832fff3f84114a1eddc6ad68e7746'}
...
with DAG(**dag_config) as dag:
    ...
    TrainTestS_fdb7e68571cf452dbbca9db0060fb594 = Task(
        ...
        piece={'name': 'TrainTestSplitPiece', 'source_image': 'ghcr.io/tauffer-consulting/ml-domino-pieces:0.2.2-group0', 'repository_url': 'https://github.com/Tauffer-Consulting/ml_domino_pieces', 'repository_version': '0.2.2'},
    ...
    InferenceM_8fd11a7c16064e009c06ba747943f8a5 = Task(
        ...
        workflow_shared_storage={'source': 'Local', 'mode': 'Read/Write', 'provider_options': {}},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '128.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '128.0Mi'}, 'use_gpu': False},
        piece={'name': 'InferenceModelPiece', 'source_image': 'ghcr.io/tauffer-consulting/ml-domino-pieces:0.2.2-group0', 'repository_url': 'https://github.com/Tauffer-Consulting/ml_domino_pieces', 'repository_version': '0.2.2'},
