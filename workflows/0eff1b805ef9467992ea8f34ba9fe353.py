...
dag_config_0 = {'start_date': '2026-02-02T13:47:00', 'schedule': None, 'catchup': False, 'dag_id': '0eff1b805ef9467992ea8f34ba9fe353'}
...
with DAG(**dag_config) as dag:
    HttpRequest_27dd10b0cd4b41a5bb118468b0a3c60b = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'method': 'GET', 'bearer_token': 'TTTT', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n'}
    )()
