...
dag_config_0 = {'start_date': '2026-02-25T16:40:00', 'schedule': None, 'catchup': False, 'dag_id': 'f782e3e8460e4ebd841b75a080ae743c'}
...
with DAG(**dag_config) as dag:
    HttpReques_ab071f4006d34dd684461ea61aea4203 = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg?w=1260&h=750', 'method': 'GET', 'bearer_token': 'SSSS', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n', 'output_type': 'both'}
    )()
