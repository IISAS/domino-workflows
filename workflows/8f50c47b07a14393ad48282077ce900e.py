...
dag_config_0 = {'start_date': '2026-02-17T08:21:00', 'schedule': None, 'catchup': False, 'dag_id': '8f50c47b07a14393ad48282077ce900e'}
...
with DAG(**dag_config) as dag:
    HttpReques_6a3825137466474e9905daa325f37e6d = Task(
        ...
        piece_input_kwargs={'url': 'https://images.pexels.com/photos/4055758/pexels-photo-4055758.jpeg', 'method': 'GET', 'bearer_token': 'XXX', 'body_json_data': '{\n    "key_1": "value_1",\n    "key_2": "value_2"\n}\n', 'output_type': 'both'}
    )()
